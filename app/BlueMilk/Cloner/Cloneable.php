...
trait Cloneable
{
    ...
    {
        return App::make('\App\BlueMilk\Cloner\Cloner')->duplicate($this);
    }
    ...
    {
        return App::make('\App\BlueMilk\Cloner\Cloner')->duplicateTo($this, $connection);
    }
